...
function initModels(sequelize) {
  ...
  post.hasMany(postComment, { as: "postComments", foreignKey: "postId", onDelete: 'cascade'} );
  postDownload.belongsTo(post, { as: "post", foreignKey: "postId"});
  post.hasMany(postDownload, { as: "postDownloads", foreignKey: "postId", onDelete: 'cascade'});
  postHashtag.belongsTo(post, { as: "post", foreignKey: "postId"});
  post.hasMany(postHashtag, { as: "postHashtags", foreignKey: "postId", onDelete: 'cascade'});
  postImage.belongsTo(post, { as: "post", foreignKey: "postId"});
  post.hasMany(postImage, { as: "postImages", foreignKey: "postId", onDelete: 'cascade'});
  postLike.belongsTo(post, { as: "post", foreignKey: "postId"});
  post.hasMany(postLike, { as: "postLikes", foreignKey: "postId", onDelete: 'cascade'});
  postShare.belongsTo(post, { as: "post", foreignKey: "postId"});
  post.hasMany(postShare, { as: "postShares", foreignKey: "postId", onDelete: 'cascade'});
